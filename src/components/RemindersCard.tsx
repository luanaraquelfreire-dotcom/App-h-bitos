...
export default function RemindersCard() {
  ...
  return (
    <div className="rounded-2xl border border-white/60 bg-white/55 shadow-[0_8px_30px_-8px_rgba(120,110,160,0.28)] backdrop-blur-xl p-4">
      ...
      {!isSupported ? (
        <p className="text-xs font-medium text-duo-red-dark">
        ...
        <button
          ...
          className={`duo-btn w-full rounded-xl border-2 py-2.5 text-sm font-semibold uppercase tracking-wide text-white ${
            enabled ? "border-duo-gray-dark bg-duo-gray-dark" : "border-duo-green-dark bg-duo-green-dark"
          }`}
        >
